...
public abstract class InjectionBuilder
{
    ...
    protected static void CreateDefaultTests(InjectionData data, string levelName)
    {
        ...
        else if (data.GameVersion == TRGameVersion.TR4)
        {
            var level = _control4.Read($"Resources/{levelName}");
            roomCount = level.Rooms.Count;

            if (level.Entities.Count > 0)
            {
                var item = level.Entities.Find(e => e.TypeID == TR4Type.Lara) ?? level.Entities[0];
                data.ApplicabilityTests.Add(new ItemMetaTest
                {
                    Index = level.Entities.IndexOf(item),
                    TypeID = (int)item.TypeID,
    ...
    protected static readonly Dictionary<string, string> _tr4NameMap = new()
    {
        [TR4LevelNames.ANGKOR] = "angkor",
        [TR4LevelNames.IRIS_RACE] = "race",
        [TR4LevelNames.SETH] = "seth",
        [TR4LevelNames.BURIAL] = "burial",
        [TR4LevelNames.VALLEY] = "valley",
        [TR4LevelNames.KV5] = "kv5",
        [TR4LevelNames.KARNAK] = "karnak",
        [TR4LevelNames.HYPOSTYLE] = "hypostyle",
        [TR4LevelNames.LAKE] = "sacred",
        [TR4LevelNames.SEMERKHET] = "semerkhet",
        [TR4LevelNames.GUARDIAN] = "guardian",
        [TR4LevelNames.TRAIN] = "train",
        [TR4LevelNames.ALEXANDRIA] = "alexandria",
        [TR4LevelNames.COASTAL] = "coastal",
        [TR4LevelNames.PHAROS] = "pharos",
        [TR4LevelNames.CLEOPATRA] = "cleopatra",
        [TR4LevelNames.CATACOMBS] = "catacombs",
        [TR4LevelNames.POSEIDON] = "poseidon",
        [TR4LevelNames.LIBRARY] = "library",
        [TR4LevelNames.DEMETRIUS] = "demetrius",
        [TR4LevelNames.CITY] = "city",
        [TR4LevelNames.TRENCHES] = "trenches",
        [TR4LevelNames.TULUN] = "tulun",
        [TR4LevelNames.BAZAAR] = "bazaar",
        [TR4LevelNames.GATE] = "gate",
        [TR4LevelNames.CITADEL] = "citadel",
        [TR4LevelNames.SPHINX_COMPLEX] = "sphinx",
        [TR4LevelNames.SPHINX_UNDER] = "under_sphinx",
        [TR4LevelNames.MENKAURE] = "menkaure_out",
        [TR4LevelNames.MENKAURE_INSIDE] = "menkaure_in",
        [TR4LevelNames.MASTABAS] = "mastabas",
        [TR4LevelNames.PYRAMID_OUT] = "pyramid_out",
        [TR4LevelNames.KHUFU] = "khufu",
        [TR4LevelNames.PYRAMID_IN] = "pyramid_in",
        [TR4LevelNames.HORUS1] = "horus_1",
        [TR4LevelNames.HORUS2] = "horus_2",
    };
}

...
public class TR3LaraAnimBuilder : LaraBuilder
{
    ...
    protected override short PoleLoopSFX => 376;
    ...
    private static TR3Level CreateExtraLevel()
    {
        ...
        var trexCommands = level.Models[TR3Type.LaraExtraAnimation_H].Animations[1].Commands;
        CreateModelLevel(level, TR3Type.Lara);
        ImportExtraAnims(level.Models, TR3Type.LaraExtraAnimation_H);
        level.Models[TR3Type.LaraExtraAnimation_H].Animations[1].Commands.AddRange(trexCommands);

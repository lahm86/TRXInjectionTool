...
public class InjectionData
{
    ...
    public static InjectionData Create(InjectionType type)
    {
    ...
    public static InjectionData Create(LC.Model.TR1Level controlledLevel, InjectionType type, bool removeMeshData = false)
    {

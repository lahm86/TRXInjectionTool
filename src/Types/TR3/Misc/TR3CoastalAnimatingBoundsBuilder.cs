...
public class TR3CoastalAnimatingBoundsBuilder : InjectionBuilder
{
    public override List<InjectionData> Build()
    {
        TR3Level level = _control3.Read($"Resources/TR3/{TR3LevelNames.COASTAL}");
        ...
        var data = InjectionData.Create(TRGameVersion.TR3, InjectionType.General, "coastal_animating_bounds");

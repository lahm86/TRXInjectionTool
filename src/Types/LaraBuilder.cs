...
public abstract class LaraBuilder : InjectionBuilder
{
    ...
    protected static void FixInteractiveHandsFreeAnims(TRModel lara)
    {
        ...
        [
            ...
            TR4LaraAnim.PickupSarcophagus,
            TR4LaraAnim.PourWaterskinHigh,
            TR4LaraAnim.PourWaterskinLow,
            TR4LaraAnim.PulleyUngrab,
            TR4LaraAnim.PutTrident,
            TR4LaraAnim.RotateSenet,

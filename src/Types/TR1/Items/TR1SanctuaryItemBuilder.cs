...
public class TR1SanctuaryItemBuilder : ItemBuilder
{
    public override List<InjectionData> Build()
    {
        ...
        data.ItemEdits.Add(SetAngle(sanctuary, 4, 16384));
        data.ItemEdits.Add(SetAngle(sanctuary, 38, -16384));
        data.ItemEdits.Add(SetAngle(sanctuary, 46, -32768));
        data.ItemEdits.Add(SetAngle(sanctuary, 54, -16384));
        data.ItemEdits.Add(SetAngle(sanctuary, 67, -16384));
        data.ItemEdits.Add(SetAngle(sanctuary, 73, -16384));

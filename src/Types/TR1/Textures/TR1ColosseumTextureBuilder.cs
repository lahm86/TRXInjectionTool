...
public class TR1ColosseumTextureBuilder : TextureBuilder
{
    public override void Build()
    {
        ...
        InjectionIO.Export(data, @"Output\colosseum_textures.bin");
    }
    ...
    private static void FixRoofTextures(InjectionData data)
    {
        ...
        // those from the beta.
        TRImage betaRoof = new(@"Resources\TR1\colosseum_roof.png");
        ...
        {
            data.Palette[i].Red = (byte)(trPalette[i].Red / 4);
            data.Palette[i].Green = (byte)(trPalette[i].Green / 4);
            data.Palette[i].Blue = (byte)(trPalette[i].Blue / 4);
        }

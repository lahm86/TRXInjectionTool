...
public class TR1EnemyTextureBuilder : TextureBuilder
{
    ...
    private static void FixLarson()
    {
        ...
        InjectionData data = InjectionData.Create(qualopec, InjectionType.TextureFix);
        InjectionIO.Export(data, @"Output\larson_textures.bin");
    }

    private static void FixSkateboardKid()
    {
        ...
        InjectionIO.Export(data, @"Output\skateboardkid_textures.bin");
    }

    private static void FixCowboy()
    {
        InjectionData data = InjectionData.Create(InjectionType.TextureFix);
        ...
        InjectionIO.Export(data, @"Output\cowboy_textures.bin");
    }

    private static void FixKold()
    {
        InjectionData data = InjectionData.Create(InjectionType.TextureFix);
        ...
        InjectionIO.Export(data, @"Output\kold_textures.bin");
    }
}

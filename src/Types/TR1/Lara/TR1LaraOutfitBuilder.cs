...
public class TR1LaraOutfitBuilder : OutfitBuilder
{
    ...
    private const int _gameJointsBase = 296;
    ...
    protected override TRLevelBase CreateLevel(TR2Level outfitLevel)
    {
        ...
        level.Models[(TR1Type)skinId++] = NatlaSkin.Build(
        ...
        {
            level.Models[(TR1Type)(_gameJointsBase + i)] = outfitLevel.Models[(TR2Type)(_jointsBase + i)];
        }

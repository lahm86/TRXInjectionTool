...
public class TR1LaraAnimBuilder : InjectionBuilder
{
    ...
    {
        {
            ...
            InjectionData data = InjectionData.Create(caves, InjectionType.LaraAnims);
            InjectionIO.Export(data, @"Output\lara_animations.bin");
        }

        {
            ...
            InjectionData data = InjectionData.Create(InjectionType.LaraJumps);
            ImportTR2Jumping(data);
            InjectionIO.Export(data, @"Output\lara_jumping.bin");
        }
    }
    ...
    static void ImportUWRoll(TRModel tr1Lara)
    {
        ...
        // See PR 1272/1276
        TR1Level animLevel = _control1.Read(@"Resources\TR1\uw_roll_imp6.phd");
